...
function  countYearsInOffice(presidentsArr) {
 return presidentsArr.reduce((accumulator, president) => {
    if (presidents.leftOffice === "null"){
      ...
      return accumulator + (president.tookOffice - president.leftOffice);
    }},0);
}
// Iteration 4 | Sort Presidents by Birth Year - `sort()`
function sortPresidentsByBirthYear(presidentsArr) {
  return presidentsArr.sort((currentPresident, nextPresident)=>currentPresident.birthYear - nextPresident.birthYear);
}
